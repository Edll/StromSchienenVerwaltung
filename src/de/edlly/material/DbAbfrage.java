 ...
 * 
 * 
 * Attribute: id: Id des Materials MaterialSorteId: Id der Material Sorte x: Breite des Materials g z: Dicke des
 * Materials SqlConn: Database Connection aus aufgerufenen Klasse
 * 
 * Methoden: SelectId() Abfrage eine Materials Anhand der Material Id. Gibt diese als int Array zurück
 * SelectTableString() Gibt die Komplette Table als String Array zurück SelectTableInt() Gibt die Komplette Table als
 * Int Array zurück SelectTableFormat() Gibt die Komplette Table als String mit Formatierung zurück
 * SelectMaterialSorteId() Gibt den Material String aus der DB wieder SelectTableMaterialSorteString() Gibt die
 * Komplette Table MaterialSorte als String Array zurück
 * 
 * @author Edlly
 *
 */
public class DbAbfrage {
    ...
    /**
     * Erstellt ein Array das eine Formatierte Ausgabe der Material Table zur Verf�gung stellt.
     * 
     * @return
     */
